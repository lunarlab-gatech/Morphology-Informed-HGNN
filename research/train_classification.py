...
def main():
    ...
    # Train the model
    train_model(train_dataset, val_dataset, test_dataset, num_layers=12, hidden_size=128,  logger_project_name="grfgnn-classification", batch_size=30, regression=False, lr=0.0003, epochs=15)
